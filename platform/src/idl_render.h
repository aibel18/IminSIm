...
namespace idl {
	...
	struct IDL_API Render {
		...
		virtual void setOrtoProjection(float left, float right, float bottom, float top, float near = -1.0f, float far = 1.0f) = 0;
		...
		virtual void drawPointData(u32 &vao, int count) = 0;
