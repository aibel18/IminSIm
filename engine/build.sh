...
compilerFlags="-shared -fdeclspec -fPIC -fuse-ld=lld -flto=thin -Wl,--thinlto-cache-dir=$BUILD"
compilerFlags="$compilerFlags -Wvarargs -Wall -Werror -Wno-missing-braces -Wno-unused-variable"
